...
MovementMessage::MovementMessage(unsigned int worldID, sf::Vector2f velocity, unsigned int senderID)
{
	...
	memcpy(data.data() + sizeof(unsigned int), &velocity, sizeof(sf::Vector2f));
}
